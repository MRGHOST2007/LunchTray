...
fun CheckoutScreen(
    ...
    val orderDetails = "Entree: ${orderUiState.entree!!.name}" +
            "\nSideDish: ${orderUiState.sideDish!!.name}" +
            "\nAccompaniment: ${orderUiState.accompaniment!!.name}" +
            "\nTotal: ${orderUiState.orderTotalPrice}$" +
            "\n\nThank you!"
    ...
    Column(
        ...
        Row(
            ...
            Button(
                ...
                onClick = {
                    onNextButtonClicked("New Order Submitted!", orderDetails)
                }
            ) {
